...
class Eeprom24C32_64
{
    public:
        ...
        template <typename TW> void write(const unsigned int, const TW *);
        ...
        template <typename TR> void read(const unsigned int, TR *);
 ...
 */
template <typename TW> void Eeprom24C32_64::write(const unsigned int address, const TW *data) {
	writeBytes( address, sizeof(TW), (byte *)data);
}
 ...
 */
template <typename TR> void Eeprom24C32_64::read(const unsigned int address, TR *data) {
	readBytes(address, sizeof(TR), (byte *)data);
}
